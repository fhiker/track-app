...
var getOperationName = (r2) => {
  for (var e3 of r2.definitions) {
    if (e3.kind === e2.OPERATION_DEFINITION) {
...
var formatNode = (r2) => {
  ...
  if ("selectionSet" in r2) {
    var u3 = [];
    var p3 = r2.kind === e2.OPERATION_DEFINITION;
    if (r2.selectionSet) {
      for (var d3 of r2.selectionSet.selections || []) {
        p3 = p3 || d3.kind === e2.FIELD && "__typename" === d3.name.value && !d3.alias;
...
function gql(n2) {
  ...
  for (var p3 of i3) {
    for (var d3 of p3.definitions) {
      if (d3.kind === e2.FRAGMENT_DEFINITION) {
...
var ssrExchange = (e3 = {}) => {
  ...
  var ssr = ({ client: o3, forward: i3 }) => (s2) => {
    ...
    var u3 = i3(map(mapTypeNames)(filter((e4) => "teardown" === e4.kind || !a2[e4.key] || !!a2[e4.key].hasNext || "network-only" === e4.context.requestPolicy)(s2)));
    var p3 = map((e4) => {
      var i4 = ((e5, r3, t3) => ({
        operation: e5,
    ...
    })(filter((e4) => "teardown" !== e4.kind && !!a2[e4.key] && "network-only" !== e4.context.requestPolicy)(s2));
    if (!c3) {
      u3 = onPush((e4) => {
        var { operation: r3 } = e4;
        if ("mutation" !== r3.kind) {
...
//# sourceMappingURL=chunk-6UYQSB3T.js.map
